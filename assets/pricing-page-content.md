# Pricing Page Content - InvestigatePro

> **CANONICAL PRICING SOURCE** — decided 2026-07-03 (Launch WBS 1.8). Every other asset (site, deck, emails, ads, listings, agents) derives from this file. If pricing changes, change it HERE first.

---

## The Ladder

| Tier | Monthly | Annual (per mo) | Users | Key gates |
|------|---------|-----------------|-------|-----------|
...
**50% off year one** — limited founding cohort. Plus white-glove onboarding and priority feature requests. No "3 months free", no "90-day pilot" framing (retired 2026-07-03).

Stripe implementation: coupon `FOUNDING50`, 50% off, duration 12 months, capped redemptions.

## Headline Options

**A (Value):** Better investigations. Fewer repeat incidents. Simple pricing.
**B (ROI):** One prevented incident pays for years of InvestigatePro.
**C (Comparison):** Enterprise methodology. SMB pricing.
